-- Факт проведения для крупного лида: любая проведённая встреча по БИН (не только «Крупный лид»).
-- Чтобы смена типа админом или уже сохранённая «Новая» не требовали второй строки.
