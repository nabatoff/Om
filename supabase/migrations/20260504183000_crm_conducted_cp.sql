-- ЦП (цепь): отправлено да/нет + количество для проведённых встреч.

ALTER TABLE public.crm_conducted_meetings
  ADD COLUMN IF NOT EXISTS cp_sent boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS cp_quantity integer NOT NULL DEFAULT 0;
