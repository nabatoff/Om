-- Откат 20260825120000: менеджеры не хотят, чтобы лид «в работе» задерживался в «Мои лиды
-- Крупный бизнес» — он должен пропадать сразу, как раньше. Возвращаем in_work в список
-- исключений mine_assigned (остаётся только completed из более старой версии убрано).
